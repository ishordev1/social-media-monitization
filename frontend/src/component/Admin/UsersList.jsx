...
const UsersList = ({ users, onStatusUpdate }) => {
  ...
  const handleStatusChange = (email, newStatus, userId) => {
          ...
          <div className="card h-100 shadow-lg border-0 overflow-hidden hover-effect">
            ...
            <div className="card-header-gradient py-3 px-5">
              <div className="d-flex align-items-center">
                <div className="position-relative">
                  <img
                    src={user.imgName ? user.imgName : 'https://via.placeholder.com/70'}
                    alt={user.name}
            ...
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between align-items-center mt-4">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end shadow">
                    <li>
                      <button
                        ...
                        onClick={() => handleStatusChange(user.email, 'PENDING', user.userId)}
                      >
                    ...
                    <li>
                      <button
                        className="dropdown-item d-flex align-items-center"
                        onClick={() => handleStatusChange(user.email, 'VERIFY', user.userId)}
                      >
                    ...
                    <li>
                      <button
                        className="dropdown-item d-flex align-items-center"
                        onClick={() => handleStatusChange(user.email, 'DISABLE', user.userId)}
                      >
                ...
                <span onClick={() => { deleteUserHandle(user.userId) }} className="fw-bold "> <i class="fa-solid fa-trash text-danger"></i></span>
              </div>
            </div>
          </div>
        </div>
